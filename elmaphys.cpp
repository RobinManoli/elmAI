...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "smibu_phys\\BodyPart.cpp",
            "smibu_phys\\BodyPart.h",
            "smibu_phys\\ElmaPhys.cpp",
            "smibu_phys\\Engine.cpp",
            "smibu_phys\\Engine.h",
            "smibu_phys\\Errors.cpp",
            "smibu_phys\\Errors.h",
            "smibu_phys\\KuskiState.cpp",
            "smibu_phys\\KuskiState.h",
            "smibu_phys\\Level.cpp",
            "smibu_phys\\Level.h",
            "smibu_phys\\LevelData.cpp",
            "smibu_phys\\LevelData.h",
            "smibu_phys\\Levobj.cpp",
            "smibu_phys\\Levobj.h",
            "smibu_phys\\Picture.cpp",
            "smibu_phys\\Picture.h",
            "smibu_phys\\PlayerData.cpp",
            "smibu_phys\\PlayerData.h",
            "smibu_phys\\Point2D.cpp",
            "smibu_phys\\Point2D.h",
            "smibu_phys\\Polygon.cpp",
            "smibu_phys\\Polygon.h",
            "smibu_phys\\Replay.cpp",
            "smibu_phys\\Replay.h",
            "smibu_phys\\math2d.cpp",
            "smibu_phys\\math2d.h",
            "smibu_phys\\top10data.cpp",
            "smibu_phys\\top10data.h"
        ],
        "include_dirs": [
            "."
        ],
...
#define __PYX_HAVE__elmaphys
#define __PYX_HAVE_API__elmaphys
/* Early includes */
#include "math.h"
#include <string.h>
#include "ios"
...
#include <string>
#include <stdio.h>
#include "smibu_phys/Replay.cpp"
#include "smibu_phys/Replay.h"
#include "smibu_phys/LevelData.cpp"
#include "smibu_phys/LevelData.h"
#include "smibu_phys/Polygon.cpp"
#include "smibu_phys/Polygon.h"
#include "smibu_phys/Errors.cpp"
#include "smibu_phys/Errors.h"
#include "smibu_phys/PlayerData.cpp"
#include "smibu_phys/PlayerData.h"
#include "smibu_phys/Level.cpp"
#include "smibu_phys/Level.h"
#include "smibu_phys/Levobj.cpp"
#include "smibu_phys/Levobj.h"
#include "smibu_phys/top10data.cpp"
#include "smibu_phys/top10data.h"
#include "smibu_phys/Picture.cpp"
#include "smibu_phys/Picture.h"
#include "smibu_phys/math2d.cpp"
#include "smibu_phys/math2d.h"
#include "smibu_phys/Engine.cpp"
#include "smibu_phys/Engine.h"
#include "smibu_phys/Point2D.cpp"
#include "smibu_phys/Point2D.h"
#include "smibu_phys/BodyPart.cpp"
#include "smibu_phys/BodyPart.h"
#include "smibu_phys/KuskiState.cpp"
#include "smibu_phys/KuskiState.h"
#include "smibu_phys/ElmaPhys.cpp"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static PyObject* __pyx_convert__to_py_struct__phys_3a__3a_Point2D(struct phys::Point2D s);
static PyObject* __pyx_convert__to_py_struct__phys_3a__3a_BodyPart(struct phys::BodyPart s);
...
/* Module declarations from 'celmaphys' */

/* Module declarations from 'elmaphys' */
#define __Pyx_MODULE_NAME "elmaphys"
extern int __pyx_module_is_main_elmaphys;
int __pyx_module_is_main_elmaphys = 0;

/* Implementation of 'elmaphys' */
...
static int __pyx_pymod_exec_elmaphys(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_elmaphys},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initelmaphys(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initelmaphys(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_elmaphys(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_elmaphys(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_elmaphys(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'elmaphys' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_elmaphys(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("elmaphys", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_elmaphys) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "elmaphys")) {
      if (unlikely(PyDict_SetItemString(modules, "elmaphys", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init elmaphys", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init elmaphys");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static PyObject* __pyx_convert__to_py_struct__phys_3a__3a_BodyPart(struct phys::BodyPart s) {
  ...
  PyObject* member;
  res = __Pyx_PyDict_NewPresized(2); if (unlikely(!res)) return NULL;
  member = PyFloat_FromDouble(s.rotation); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_rotation, member) < 0)) goto bad;
  Py_DECREF(member);
  member = __pyx_convert__to_py_struct__phys_3a__3a_Point2D(s.location); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_location, member) < 0)) goto bad;
  Py_DECREF(member);
  return res;
  bad:
  Py_XDECREF(member);
